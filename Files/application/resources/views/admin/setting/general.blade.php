                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-9 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-text p-0 border-0">
                                            <input type='text' class="form-control colorPicker"
                                                value="{{$general->theme_four_base_color}}" />
                                        </span>
                                        <input type="text" class="form-control colorCode" name="theme_four_base_color"
                                            value="{{$general->theme_four_base_color}}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-text p-0 border-0">
                                            <input type='text' class="form-control colorPicker"
                                                value="{{$general->theme_five_base_color}}" />
                                        </span>
                                        <input type="text" class="form-control colorCode" name="theme_five_base_color"
                                            value="{{$general->theme_five_base_color}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-5">
                                ...
                                <div class="col-md-9 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-text p-0 border-0">
                                            <input type='text' class="form-control colorPicker"
                                                value="{{$general->theme_five_secondary_color}}" />
                                        </span>
                                        <input type="text" class="form-control colorCode" name="theme_five_secondary_color"
                                            value="{{$general->theme_five_secondary_color}}" />
                                    </div>
                                </div>
                            </div>
                            {{-- end theme five color --}}
                            @endif
