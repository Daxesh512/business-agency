            ...
            <div class="top-header-wrapper">
                <div class="top-contact">
                    <ul class="contact-list">
                        <li class="contact-list__item"> <span class="contact-list__item-icon"><i class="fas fa-phone"></i></span><a href="tel:{{$contact->data_values->contact_number}}" class="contact-list__link">944740844</a></li>
                        <li class="contact-list__item"> <span class="contact-list__item-icon"><i class="fas fa-envelope"></i></span><a href="mailto:{{$contact->data_values->email_address}}" class="contact-list__link">Turgunoff@gmail.com</a></li>
                    </ul>
                </div>
